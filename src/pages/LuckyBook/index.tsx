...
const LuckyBook = () => {
  ...
  return (
    <div className="w-full md:w-fit h-full md:h-[calc(-95px-0.5rem+100dvh)] max-h-[calc(1345px-0.5rem)] flex flex-col items-center bg-white md:mx-auto mt-[65px] xl:mt-[15px] rounded-[10px]">
      ...
      <div className="flex flex-col w-full md:w-[85%] relative max-w-[700px] rounded-t-[46px] bg-white md:mt-[-30px] md:pt-[100px] px-1 md:px-0">
        <div className="md:hidden relative md:absolute -top-[20px] left-[50%] -translate-x-[50%] w-[275px] sm:w-[315px] md:w-[400px]">
